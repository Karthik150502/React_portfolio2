        ...
        <ul class="cards">
            ...
            <div class="card">
                ...
                <div className="btns">
                    ...
                    <a href="https://warm-vacherin-4ff7cf.netlify.app/" class="btn card_btn" target="_blank">Demo</a>
                </div>
                </div>
            </div>
            </li>
            ...
            <div class="card">
                ...
                <div className="btns">
                    <a href="https://github.com/Karthik150502/OnlineGamesSite" target="_blank" class="btn card_btn">Source</a>
                    <a href="https://creative-bunny-f299fd.netlify.app/" target="_blank" class="btn card_btn">Demo</a>
                </div>
                </div>
            </div>
            </li>
            ...
            <div class="card">
                ...
                <div className="btns">
                    <a href="https://github.com/Karthik150502/LoadingAnimaion2" target="_blank" class="btn card_btn">Source</a>
                    <a href="https://golden-liger-47e74b.netlify.app/" class="btn card_btn" target="_blank">Demo</a>
                </div>
                </div>
            </div>
            </li>
            ...
            <div class="card">
                ...
                <div className="btns">
                    <a href="https://github.com/Karthik150502/Django_CRM_Aug_2023" target="_blank" class="btn card_btn">Source</a>
            ...
            <div class="card">
                ...
                <div className="btns">
                    <a href="https://github.com/Karthik150502/Django_Portfolio_Aug_2023" target="_blank" class="btn card_btn">Source</a>
